 ...
 */
    ...
    {     
        $instruccion1 = "select a.ID, a.CROTAL, a.NOMBRE, a.tiempoExplotacion, v.DESCRIPCION from animales a, vital v where a.habilitado ='1' and a.IDVITAL = v.ID and a.IDVITAL = 2 order by a.IDVITAL asc";
        ...
        for ($i=0; $i<$nf1; $i++)
        {
            ...
            array_push($arr, array("ID"=>$res3["ID"], "CROTAL"=>$res3["CROTAL"], "NOMBRE"=>$res3["NOMBRE"], "vital"=>$res3["DESCRIPCION"], "tiempoExplotacion"=>$res3["tiempoExplotacion"],"tiempoExplotaciont"=>"420"));
        }      
    ...
    {
        $instruccion1 = "select * from vital where ID IN('2','4', '6')";
        $res1=mysqli_query ($conexion ,$instruccion1);
        $nf1= mysqli_num_rows($res1);
