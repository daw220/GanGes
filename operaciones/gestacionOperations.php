 ...
 */
    ...
    {     
        ...
        for ($i=0; $i<$nf1; $i++)
        {
            ...
            array_push($arr, array("ID"=>$res3["ID"], "CROTAL"=>$res3["CROTAL"], "NOMBRE"=>$res3["NOMBRE"], "vital"=>$res3["DESCRIPCION"], "tiempoExplotacion"=>$res3["tiempoExplotacion"],"tiempoExplotacionT"=>"270"));
        }      
